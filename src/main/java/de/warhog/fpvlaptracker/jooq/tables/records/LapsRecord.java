...
public class LapsRecord extends UpdatableRecordImpl<LapsRecord> implements Record5<Integer, Integer, Integer, Integer, Integer> {

    private static final long serialVersionUID = -492940640;
     ...
     */
    public LapsRecord setChipid(Integer value) {
        set(2, value);
        return this;
    }
     ...
     */
    @Override
    public LapsRecord value3(Integer value) {
        setChipid(value);
        return this;
    }
     ...
     */
    @Override
    public LapsRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LapsRecord(Integer id, Integer raceid, Integer chipid, Integer lap, Integer duration) {
        super(Laps.LAPS);
